...
const DIALOG_CLICK_PROTECTION_DELAY = 20;
...
var powersDamage = 1;              // Universal power damage multiplier
var powersDiameter = 1;            // Universal power area multiplier
var powersCount = 1;               // Universal power count multiplier
var powersCooldownReduction = 0;   // Universal power cooldown reduction (0-80%)
var powersDuration = 1;            // Universal power duration multiplier
var powersPenetration = 0;         // Universal power penetration bonus
var areaDamage = 1;                // Area-based ability damage (Bomb, Singularity)
...
const attachmentLevels = {
  ...
  14: {
    ...
    levels: {
      0: { 
        cost: 1000, 
        itemInfo: "-Not Implemented Yet- Increases and reductions to Cooldown Reduction instead apply to Shield Recharge at 50% reduced effectiveness.", 
        stats: [], conversion: {} },
      1: { 
        cost: 2500, 
        itemInfo: "-Not Implemented Yet- Increases and reductions to Cooldown Reduction instead apply to Shield Recharge at 45% reduced effectiveness.", 
        stats: [], conversion: {} },
      2: { 
        cost: 4800, 
        itemInfo: "-Not Implemented Yet- Increases and reductions to Cooldown Reduction instead apply to Shield Recharge at 40% reduced effectiveness.", 
        stats: [], conversion: {} },
      3: { 
        cost: 6500, 
        itemInfo: "-Not Implemented Yet- Increases and reductions to Cooldown Reduction instead apply to Shield Recharge at 35% reduced effectiveness.", 
        stats: [], conversion: {} }
    }
  },
...
const stage1Waves = [
  ...
  },
  {
    startTime: 15,
    spawns: [
      { type: "chip", amount: 1, side: "center", delay: 1, repeat: 1, radius: 680, cycleDelay: 40 }
    ]
  },  
  {
    startTime: 22,
...
const stage2Waves = [
  {
    startTime: 0, 
    spawns: [
      { type: "superdia", amount: 2, side: "grid", delay: 0.5, repeat: 2, cycleDelay: 4 }
    ]
  },
  {
    startTime: 8,
    spawns: [
      { type: "bozog", amount: 1, side: "left", delay: 0.2, repeat: 2, cycleDelay: 4 }
    ]
  },
  {
    startTime: 16,
    spawns: [
      { type: "turbozo", amount: 2, side: "left", delay: 1, repeat: 2, radius: 480, cycleDelay: 4 }
    ]
  },
  {
    startTime: 24,
    spawns: [
      { type: "turbozog", amount: 1, side: "bottom", delay: 2, repeat: 2, radius: 1000, cycleDelay: 4 }
    ]
  },
  {
    startTime: 32,
    spawns: [
      { type: "gigagrower", amount: 2, side: "center", delay: 1, repeat: 2, radius: 480, cycleDelay: 4 }
