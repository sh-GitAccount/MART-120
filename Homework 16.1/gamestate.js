...
function RestartGame() {
    ...
    shot_PowerArray = [];
    shot_RemovalDelay = [];
    console.error("Projectiles cleared");
    ...
    items_Frame = [];
    items_Amount = [];
    console.error("Items cleared");
    
    // Clear explosions
    bombExplosions = [];
    console.error("Explosions cleared");
    
    // Reset abilities
    ResetAllAbilities();
    ResetAbilityCooldownSystem();
    console.error("Abilities reset");
    ...
    console.error("Player stats reset");
    ...
    blaster_BurstTimer = [];
    blaster_ShotsFired = [];
    console.error("Support units reset");
    ...
    console.error("Position reset to", player_X, player_Y);
    ...
    // IMPORTANT: Reset the wave system
    try {
    ...
    // SET GAME STATE
    game_State = true;
    game_Screen = "playing";  // MAKE SURE THIS IS CAMELCASE
    justRestarted = true;
    
    console.error("game_State:", game_State, "game_Screen:", game_Screen);
...
function LoadStage(stageNumber = stage) {
    ...
    console.log("Stage loaded: activeWaves set, player positioned, arrays cleared");
}
