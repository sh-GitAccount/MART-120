// PRELOAD ASSETS
function preload() {
  console.log("Loading sound array. . . ");
  //UI/Menu sfx
  sounds.error = [];
  ...
  sounds.lightningchain = [];
  sounds.lightningecho = [];
  sounds.abilitylightningbolt = [];
  sounds.ice = [];
  sounds.icecrash = [];
  sounds.iceshard = [];
  ...
  sounds.fireballhit = [];
  sounds.diamondburst = [];
  sounds.diamondbursthit = [];
  sounds.diamondburstfork = [];
  ...
  musicTracks.victoryTheme = loadSound('../Audio/VictoryTheme.ogg');
  musicTracks.stageTheme = loadSound('../Audio/StageTheme.ogg');
  musicTracks.stage2Theme = loadSound('../Audio/Stage2Theme.ogg');
  musicTracks.stage3Theme = loadSound('../Audio/Stage3Theme.ogg');
  musicTracks.stage4Theme = loadSound('../Audio/Stage4Theme.ogg');
  musicTracks.deathTheme = loadSound('../Audio/DeathTheme.ogg'); 
  musicTracks.bosstrack1 = loadSound('../Audio/BossTrack1.ogg');
  musicTracks.bosstrack2 = loadSound('../Audio/BossTrack2.ogg');
  ...
  // Power spritesheets for animations
  powerSpritesheets = {};
  ...
  for (i = 0; i < SOUND_COUNT; i++) {
    ...
    sounds.lightningchain.push(loadSound('../Audio/LightningChain.ogg'));
    sounds.lightningecho.push(loadSound('../Audio/LightningEcho.ogg'));
    sounds.ice.push(loadSound('../Audio/Ice.ogg'));
    sounds.icecrash.push(loadSound('../Audio/IceCrash.ogg'));
    sounds.iceshard.push(loadSound('../Audio/IceShard.ogg'));
    sounds.fireball.push(loadSound('../Audio/Fireball.ogg'));
    sounds.fireballhit.push(loadSound('../Audio/FireballHit.ogg'));
    sounds.diamondburst.push(loadSound('../Audio/DiamondBurst.ogg'));
    sounds.diamondbursthit.push(loadSound('../Audio/DiamondBurstHit.ogg'));
    sounds.diamondburstchain.push(loadSound('../Audio/DiamondBurstChain.ogg'));
    sounds.diamondburstfork.push(loadSound('../Audio/DiamondBurstFork.ogg'));
    sounds.cyclone.push(loadSound('../Audio/Cyclone.ogg'));
    sounds.cyclonehit.push(loadSound('../Audio/CycloneHit.ogg'));
  ...
  console.log("Loading image icons. . . ")
  // Upgrade images
