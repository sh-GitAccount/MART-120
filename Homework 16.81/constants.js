...
const stage1Waves = [
  ...
  },
  {
    startTime: 55,
    spawns: [
      { type: "lilfella", amount: 8, side: "square", delay: 0.2, repeat: 4, radius: 780, cycleDelay: 18 }
    ]
  },
  {
    startTime: 60,
    spawns: [
      { type: "lilfella", amount: 8, side: "circle", delay: 0.6, repeat: 5, radius: 850, cycleDelay: 14 }
    ]
  },
  {
    startTime: 65,
  ...
  },
  {
    startTime: 72,
    spawns: [
      { type: "lilfella", amount: 6, side: "top", delay: 2, repeat: 3, radius: 780, cycleDelay: 15 },
      { type: "chungusjr", amount: 1, side: "top", delay: 3, repeat: 2, radius: 500, cycleDelay: 30  }
    ]
  },    
];
