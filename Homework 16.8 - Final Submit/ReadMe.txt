Use WASD to move, use Shift to use Boost - It's currently unlimited and hasn't really been worked on yet but it works.
Q = Use to activate shield
E = Use Ship ability, varies on ship selected.
These abilities have their own cooldowns.
